        ...
        <Card className="rounded-3xl border-slate-200 shadow-sm">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-2xl">
              ...
              Configure sua reserva
            </CardTitle>
            <CardDescription>
              Descubra uma estimativa de reserva com base no seu perfil de trabalho e no seu gasto
              mensal fixo.
            </CardDescription>
          </CardHeader>

          <CardContent className="space-y-8">
            <div className="calculator-fields grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <label htmlFor="reserva-emergencia-1" className="text-sm font-medium text-slate-700">Tipo de trabalho</label>
                <select id="reserva-emergencia-1"
                  value={profile}
              ...
              <div className="space-y-2">
                <label htmlFor="reserva-emergencia-2" className="text-sm font-medium text-slate-700">Gasto mensal fixo</label>
                <Input id="reserva-emergencia-2"
                  type="text"
                  inputMode="decimal"
                  value={fixedExpense}
            ...
            <div className="calculator-results grid gap-4 md:grid-cols-2">
              ...
              <Card className="rounded-2xl bg-slate-50">
                <CardContent className="p-5">
                  ...
                  <p className="mt-2 text-2xl font-semibold">
                    {formatCurrency(result.reserveValue)}
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="rounded-2xl bg-slate-50 p-6 text-sm leading-7 text-slate-700">
              ...
              <p className="mt-4">
                Já o funcionário público, pela segurança maior do vínculo, pode trabalhar com algo
                em torno de 3 meses. Ainda assim, dependendo do conservadorismo da pessoa, ela pode
