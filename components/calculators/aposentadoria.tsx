  ...
  return (
        <Card className="rounded-3xl border-slate-200 shadow-sm">
          ...
          <CardContent className="space-y-8">
            <div className="calculator-fields grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              <div className="space-y-2">
                <label htmlFor="aposentadoria-1" className="text-sm font-medium text-slate-700">Idade atual</label>
                <Input id="aposentadoria-1"
                  type="text"
                  inputMode="decimal"
                  value={currentAge}
              ...
              <div className="space-y-2">
                <label htmlFor="aposentadoria-2" className="text-sm font-medium text-slate-700">
                  Idade que deseja se aposentar
                </label>
                <Input id="aposentadoria-2"
                  type="text"
                  inputMode="decimal"
                  value={retirementAge}
              ...
              <div className="space-y-2">
                <label htmlFor="aposentadoria-3" className="text-sm font-medium text-slate-700">
                  Patrimônio já acumulado
                </label>
                <Input id="aposentadoria-3"
                  type="text"
                  inputMode="decimal"
              ...
              <div className="space-y-2">
                <label htmlFor="aposentadoria-4" className="text-sm font-medium text-slate-700">
                  Patrimônio desejado na aposentadoria
                </label>
                <Input id="aposentadoria-4"
                  type="text"
                  inputMode="decimal"
                  value={targetValue}
              ...
              <div className="space-y-2">
                <label htmlFor="aposentadoria-5" className="text-sm font-medium text-slate-700">Tipo da taxa</label>
                <select id="aposentadoria-5"
                  value={rateType}
              ...
              <div className="space-y-2">
                <label htmlFor="aposentadoria-6" className="flex items-center gap-2 text-sm font-medium text-slate-700">
                  {rateLabel}
                  <span
            ...
            <div className="calculator-results grid gap-4 md:grid-cols-4">
