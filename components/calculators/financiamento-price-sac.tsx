          ...
          <CardContent className="space-y-8">
            <div className="calculator-fields grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <div className="space-y-2">
                <label htmlFor="financiamento-price-sac-1" className="text-sm font-medium text-slate-700">Valor do financiamento</label>
                <Input id="financiamento-price-sac-1"
                  type="text"
                  inputMode="decimal"
                  value={loanAmount}
              ...
              <div className="space-y-2">
                <label htmlFor="financiamento-price-sac-2" className="text-sm font-medium text-slate-700">
                  Quantidade de parcelas
                </label>
                <Input id="financiamento-price-sac-2"
                  type="text"
                  inputMode="decimal"
                  value={installments}
              ...
              <div className="space-y-2">
                <label htmlFor="financiamento-price-sac-3" className="text-sm font-medium text-slate-700">Tipo do CET</label>
                <select id="financiamento-price-sac-3"
                  value={cetType}
              ...
              <div className="space-y-2">
                <label htmlFor="financiamento-price-sac-4" className="text-sm font-medium text-slate-700">CET (%)</label>
                <Input id="financiamento-price-sac-4"
                  type="text"
                  inputMode="decimal"
                  value={cetValue}
