  ...
  return (
        <Card className="rounded-3xl border-slate-200 shadow-sm">
          ...
          <CardContent className="space-y-8">
            <div className="calculator-fields grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <div className="space-y-2">
                <label htmlFor="juros-compostos-1" className="text-sm font-medium text-slate-700">Valor inicial</label>
                <Input id="juros-compostos-1"
                  type="text"
                  inputMode="decimal"
                  value={initialAmount}
              ...
              <div className="space-y-2">
                <label htmlFor="juros-compostos-2" className="text-sm font-medium text-slate-700">Aporte mensal</label>
                <Input id="juros-compostos-2"
                  type="text"
                  inputMode="decimal"
              ...
              <div className="space-y-2">
                <label htmlFor="juros-compostos-3" className="text-sm font-medium text-slate-700">Tipo da taxa</label>
                <select id="juros-compostos-3"
                  value={rateType}
              ...
              <div className="space-y-2">
                <label htmlFor="juros-compostos-4" className="text-sm font-medium text-slate-700">{taxaLabel}</label>
                <Input id="juros-compostos-4"
                  type="text"
                  inputMode="decimal"
                  value={rateValue}
              ...
              <div className="space-y-2 lg:col-span-2">
                <label htmlFor="juros-compostos-5" className="text-sm font-medium text-slate-700">{prazoLabel}</label>
                <Input id="juros-compostos-5"
                  type="text"
                  inputMode="decimal"
                  value={termValue}
            ...
            <div className="calculator-results grid gap-4 md:grid-cols-3">
